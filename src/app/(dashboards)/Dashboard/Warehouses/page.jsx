  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-x-2 justify-end my-5">
        <ButtonWithModal title="Add Warehouse"></ButtonWithModal>
      </div>

      <DashboardTable columns={columns} data={warehousesData} loading={warehousesIsLoading} />
      ...
      <EditModal isEditModalOpen={isEditModalOpen} title="Edit Warehouse">
        <EditWarehouses selectedWarehouse={selectedCustomer} /> 
      </EditModal>
